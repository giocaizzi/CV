...
\begin{sectionElementsList}
  \skillsElement{2}{
    ...
    \skillsItem{Data Science}{pandas, numpy, scikit-learn, tensorflow, matplotlib, seaborn, plotly}
    \skillsItem{GIS}{ArcGIS, arcpy, QGis, PostGIS, GDAL, geopandas, shapely, pyproj, rasterio}
    \skillsItem{CAD}{AutoCAD, Civil3D}
