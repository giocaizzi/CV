...
\begin{sectionElementsList}
  \skillsElement{2}{
    ...
    \skillsItem{Cloud}{Infrastructures on AWS, GCP \& Azure}
    \skillsItem{Deployments}{Docker containers \& Serverless}
    \skillsItem{Data}{ SQL \& noSQL, Redis}
    \skillsItem{Development}{git, testing, docs, CI/CD pipelines}
    \skillsItem{GenAI}{Langchain, MS Copilot Studio, OpenAI API, HuggingFace, langgraph, LlamaIndex}
    \skillsItem{API}{REST \& GraphQL, OpenAPI}
    \skillsItem{Observability}{Opentelemetry, Prometheus, Grafana}
    \skillsItem{Web frameworks}{Flask, FastAPI, Django, Express}
    \skillsItem{Data Science}{pytorch, pandas, numpy, sklearn }
    \skillsItem{GIS}{ArcGIS, QGis, PostGIS, GDAL, geopandas, shapely}
