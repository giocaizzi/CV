...
\skillsMulticolListStart
  \skillsMulticolItem{GIS \& CAD}{ArcGIS \& QGis, AutoCAD, Civil3D}
  \skillsMulticolItem{Business Intelligence}{Power BI}
  \skillsMulticolItem{DataBase}{SQL \& PostGIS}
  \skillsMulticolItem{Cloud \& Automation}{Amazon Web Services (AWS), Google Cloud Platform (GCP), Azure, GitHub actions}
  \skillsMulticolItem{Software Development}{git, unit testing \& integration testing, Documentation, CI \& CD}
  \skillsMulticolItem{Programming}{python, shell scripting}
  \skillsMulticolItem{Writing}{\LaTeX\:, Markdown \& reStructuredText}
  \skillsMulticolItem{Web}{HTML \& CSS}
