...
% The CV is structured as a list of subheadings 
% that are a table with basic information,
% each subheading has a list of items consising 
...
\newcommand{\resumeSubSubheading}[2]{
  % create new item in the list
  \item
    % new table with 2 columns like in resumeSubheading
